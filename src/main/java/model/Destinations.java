...
public class Destinations {
    ...
    private ObservableList<Destination> displayDestinations;
    private Agency agency;

    public void setDisplayedDestinations(ObservableList<Destination> destinations){
        this.displayDestinations = destinations;
    }

     public ObservableList<Destination> getDisplayDestinations() {
        if (displayDestinations == null){
            this.displayDestinations = this.destinations;   
        }
        return this.displayDestinations;
    }
    ...
    public void insertDummyData() {
        ...
        for (Destination d : destinations) {
            ...
            //System.out.println("size of flights="+agency.getFlights().getFlights().size());
        }
    }
}
