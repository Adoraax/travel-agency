...
public class Flights {
    ...
    private ObservableList<Flight> displayFlights;
    ...
    public ObservableList<Flight> getFlights() {
     ...
     public ObservableList<Flight> getDisplayFlights() {
        if (displayFlights == null){
            this.displayFlights = this.flights;   
        }
        return this.displayFlights;
    }

   public void setDisplayedFlights(ObservableList<Flight> flights){
    ...
    public void removeFlight(Flight flight) throws ItemNotFoundException {
        ...
        this.flights.remove(flight);
                System.out.println("remove called "+ flights.size());
